...
In this exercise, you will work through creating a sketchnote based on a chapter from the book, _Pulling Togther - A Guide for Indigenization of Post-Secondary Institutions_. If you have any questions or get stuck as you work through this, please ask your instructor for assistance.  Have fun!
...
3.  Create a title for your sketchnote. You might want to use something like, “Indigenous Pedagogies”, but please make sure to use a title that is meaningful to you based on what were the key points of the article that stook out to you when you highlighed key concepts and information.
4.  Sketchnote the main concepts and information, using a format or layout that you’ve decided to use. 
  - If you need some inspiration, please take another look at the [Skills Building handout](act-1-skills-building.html){:target="_blank"} again. 
...
[NEXT STEP: Sketchnotes to Learn a Language](act-5-language.html){: .btn .btn-blue }
